...
详细字段视图、角色权限和运营动作建议见 `docs/cloudbase-cms-operations.md`。

## 本地验证

```bash
npx -y -p typescript@5.4.5 tsc --noEmit --project D:\HL_dev_cloud\tsconfig.json
node --check D:\HL_dev_cloud\cloudfunctions\hlApi\index.js
```
