...
function ratioByKey(ratios, key) {
...
function clampFrame(frame) {
    ...
    if (y > crop.y)
        y = crop.y;
    if (x + width < crop.x + crop.width)
        x = crop.x + crop.width - width;
    if (y + height < crop.y + crop.height)
...
function exportSizeForRatio(ratio) {
...
Page({
    ...
    onLoad() {
        ...
        cropState.channel.on('crop:init', (payload) => {
